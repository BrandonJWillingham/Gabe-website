...
export default function Home() {
  return (
    <div className="">
      <main className="">
        <div className="hero" style={{height:"100svh",width:"100%",boxShadow:"0 1vh 50px"}}>
          ...
          />
          <Navigation/>
          <div className="Hero-text" style={{width:"100%",display:"flex",flexDirection:"column",height:"100svh",justifyContent:"space-around"}}>
            ...
            <div style={{display:"flex", justifyContent:"center",height:"40%"}}>
                ...
                <h4 style={{display:"flex", justifyContent:"center",marginTop:"15svh"}} className="gradient-outline-orange text-[clamp(1rem,6vw,2.2rem)] font-bold" data-text="Reserve your training">
                  <a href="/Contact">
